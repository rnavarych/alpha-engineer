# Infrastructure Cost Estimation, TCO, and Build vs. Buy

## When to load
Load when estimating infrastructure costs (compute, storage, network, managed services), calculating 3-year TCO, evaluating build vs. buy decisions, or comparing pricing models.
...
- Size instances by profiling: CPU-bound workloads need compute-optimized instances, memory-bound need memory-optimized, and I/O-bound need storage-optimized.
