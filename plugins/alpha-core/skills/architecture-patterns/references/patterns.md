...
## When to load
Load as a concise quick-reference for Saga, Circuit Breaker, EDA event types, API composition, data management, and deployment patterns when you need a fast lookup without full detail.
